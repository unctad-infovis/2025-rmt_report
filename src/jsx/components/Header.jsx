    ...
    <div className="header_container">
      ...
      <div className="content_bottom">
        ...
        <div className="download_buttons_container">
          <a href="https://unctad.org/system/files/official-document/rmt2025_overview_en.pdf" target="_blank" onClick={(event) => downloadDocument(event)} type="button" aria-label="Download Overview" className="overview" rel="noreferrer">Overview</a>
          <a href="https://unctad.org/system/files/official-document/rmt2025_en.pdf" target="_blank" onClick={(event) => downloadDocument(event)} type="button" aria-label="Download Full Report" className="pdf_download" rel="noreferrer">Full report</a>
              ...
              <button onClick={() => scrollTo(`.chapter_header_${i + 1}`, `Chapter ${i + 1}`)} type="button" key={chapter_title}>
                <div className="chapter_navigation">
                  ...
                  <div className="chapter_meta">
                    ...
                    {
                      i < 4 && <a href={`https://unctad.org/system/files/official-document/rmt2025_ch0${i + 1}_en.pdf`} target="_blank" onClick={(event) => downloadDocument(event)} className="chapter_download_button" aria-label={`Download Chapter ${i + 1}`} rel="noreferrer" />
                    }
